              ...
              <div className="mb-8 md:mb-[53px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
                  ...
                  <TextField
                    ...
                    placeholder="lawrence@gmail.com"
                  />
                  <TextField
                    label="Phone Number"
                    value={phone}
              ...
              <div className="mb-8 md:mb-[61px]">
                ...
                <div className="flex flex-col gap-6">
                  <TextField
                    ...
                    placeholder="20 Sunshine Estate"
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
                    <TextField
                      label="ZIP Code"
                ...
                {paymentMethod === "cash" && (
                  <div className="mt-8 flex gap-8">
                    ...
                    <p className="text-[15px] text-black/50 leading-[25px]">
                      Cash on Delivery allows you to pay with cash when the courier delivers your order to your address. Please ensure your delivery details are accurate to avoid cancellation.
                    </p>
                  </div>
                )}
              </div>
