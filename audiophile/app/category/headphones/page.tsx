      ...
      <section className="container mx-auto px-6 md:px-16 py-24 space-y-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
          ...
          <div className="text-center md:text-left space-y-6 md:order-1">
            ...
            <p className="text-[#7D7D7D] max-w-md mx-auto md:mx-0">
              As the gold standard for headphones, the XX99 Mark I offers
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left space-y-6">
            ...
            <p className="text-[#7D7D7D] max-w-md mx-auto md:mx-0">
              Enjoy your audio journey with the XX59 headphones, featuring
              comfortable ear pads and balanced sound designed for everyday
              listening.
            </p>
            <Link
              href="/products/xx59"
