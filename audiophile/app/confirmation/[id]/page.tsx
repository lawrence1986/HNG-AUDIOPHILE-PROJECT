    ...
    <div>
      ...
      <section className="relative bg-brand text-white flex flex-col justify-center items-start px-8 py-24 md:py-40">
        ...
        <div className="max-w-lg z-10">
          ...
          <h1 className="text-5xl font-bold mb-6 leading-tight">XX99 Mark II Headphones</h1>
      ...
      <section className="container mx-auto px-6 py-16 grid gap-8">
        {featured.map(p => (
          <div key={p.id} className="bg-gray-100 p-8 rounded-lg flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="text-center md:text-left md:ml-12">
              ...
              <Link href={`/products/${p.slug}`} className="bg-accent text-white px-5 py-3 rounded">
                See Product
              </Link>
            </div>
          </div>
