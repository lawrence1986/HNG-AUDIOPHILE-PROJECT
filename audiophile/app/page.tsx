...
================================== */}
<section className="relative bg-[#F1F1F1] rounded-lg mx-6 md:mx-16 my-20 overflow-hidden flex flex-col md:flex-row items-center justify-between">
  {/* ZX7 Speaker Image */}
...
{/* ================================
    FOOTER SECTION
================================== */}
<footer className="bg-[#101010] text-white py-14 md:py-16">
  <div className="container mx-auto px-6 md:px-16 text-center md:text-left space-y-10 md:space-y-0 md:space-x-0">
    {/* Top Row */}
